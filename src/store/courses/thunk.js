...
export const courseSavedThunk =
	(token, title, description, duration, authors) => async (dispatch) => {
...
export const courseDeletedThunk = (token, id) => async (dispatch) => {
...
export const courseUpdatedThunk =
	(token, id, title, description, duration, authors) => async (dispatch) => {
